...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function showJavaCode(obj) {
				//从session中获取后台生成并传过来的java代码			
			 	

			 	//暂时测试使用
				//var javaCode = "var stuno = document.getElementById('table').\n rows[id].cells[0].innerText;"
				
				//$('#codeArea').val(javaCode);
	...
	<body class="backimage" style="height: 100%; width: 100%;">
	...
	<div class="ui visible inverted left fixed vertical menu" style="opacity: 0.7;">
	            ...
	            <a class="active item" href="./modelList.jsp"><font size="3">模式列表</font></a>
	        ...
	        <div class="ui raised segment" style="margin-left: 11%; margin-top: 0%; height: 100%;">
	            <font color="black"><h3>*模式*</h3></font>
	                ...
	                <center><button type="submit" class="btn btn-primary" onclick="showJavaCode(this);">生成Java代码</button></center>             
	                </div>
	        </div>
